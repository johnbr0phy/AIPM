...
import { BookOpen, Terminal, Brain, Zap, CheckCircle, ChevronRight, ChevronDown, Github, ExternalLink, Cpu, Database, Bot, Shield, Layers, ArrowLeft, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <header className="fixed top-0 left-0 right-0 h-14 bg-white border-b border-slate-200 flex items-center justify-between px-6 z-50">
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-slate-900">AI PM Technical Fluency</span>
        </div>
        <div className="flex items-center gap-4">
          <button onClick={() => scrollToSection('start')} className="text-sm text-slate-600 hover:text-purple-600">
            Get Started
          </button>
      ...
      <div className="flex pt-14">
        ...
        <aside className="fixed left-0 top-14 bottom-0 w-80 bg-white border-r border-slate-200 overflow-y-auto p-4">
        ...
        {/* Main Content */}
        <main className="ml-80 mr-56 flex-1 px-12 py-8 max-w-4xl">
          ...
          <section id="overview" className="mb-16 scroll-mt-20">
            <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-2xl p-8 mb-8 text-center">
              <pre className="text-purple-400 text-xs sm:text-sm font-mono leading-tight mb-4">
{`     █████╗ ██╗    ██████╗ ███╗   ███╗
    ██╔══██╗██║    ██╔══██╗████╗ ████║
    ███████║██║    ██████╔╝██╔████╔██║
    ██╔══██║██║    ██╔═══╝ ██║╚██╔╝██║
    ...
    ╚═╝  ╚═╝╚═╝    ╚═╝     ╚═╝     ╚═╝`}
        ...
        <aside className="fixed right-0 top-14 bottom-0 w-56 bg-white border-l border-slate-200 overflow-y-auto p-4">
